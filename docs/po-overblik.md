...
Senest genereret: **15-09-2026 11:31**  
...
| 🔴 | [#49 – Ændring af synkronisering af data ind i Nexus](https://github.com/OS2sofd/issues/issues/49) | Afventer løsningsbeskrivelse | Mellem | 151 dage / 5 mdr. | GitHub-issue er lukket, men står fortsat i aktiv Project-status |
...
| [#15 – Behov for at kunne vise forskelligt displaynavn på ansatte med flere tilhørsforhold/AD-konti](https://github.com/OS2sofd/issues/issues/15) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | Lav | Sønderborg |
...
| [#49 – Ændring af synkronisering af data ind i Nexus](https://github.com/OS2sofd/issues/issues/49) | 151 dage / 5 mdr. | Afventer løsningsbeskrivelse | Mellem | Tønder |
...
| --- | --- | ---: | --- | --- | ---: |
| 🟠 | [#17 – SOFD GUI: Udvidet overblik over tilhørsforhold og typer](https://github.com/OS2sofd/issues/issues/17) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | Mellem | 11 dage siden |
| 🟠 | [#16 – Navne- og adressebeskyttelse:](https://github.com/OS2sofd/issues/issues/16) | 179 dage / 5.9 mdr. | Screening | – | 11 dage siden |
| 🟠 | [#15 – Behov for at kunne vise forskelligt displaynavn på ansatte med flere tilhørsforhold/AD-konti](https://github.com/OS2sofd/issues/issues/15) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | Lav | 11 dage siden |
| 🟠 | [#13 – SofdCoreADReplicator - Handlinger ved grupper](https://github.com/OS2sofd/issues/issues/13) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | Mellem | 11 dage siden |
| 🟠 | [#12 – Forstå forskel på Ansatte, Eksterne, Byrøddet, Konsulenter, Vikarer, m.m. typer af AD konti](https://github.com/OS2sofd/issues/issues/12) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | – | 11 dage siden |
| 🟠 | [#11 – Tilføj information om en AD konto er i brug + understøtte LocalExtensions i Mail skabeloner](https://github.com/OS2sofd/issues/issues/11) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | Mellem | 11 dage siden |
| 🟠 | [#9 – Person tilhørsforhold - Tilføj markering af primært tilhørsforhold](https://github.com/OS2sofd/issues/issues/9) | 179 dage / 5.9 mdr. | Klar til prioritering | Mellem | 0 dage siden |
| 🟠 | [#10 – Udvid SOFDCoreADWritebackAgent til at understøtte forsk. OU'er](https://github.com/OS2sofd/issues/issues/10) | 179 dage / 5.9 mdr. | Afventer løsningsbeskrivelse | Mellem | 11 dage siden |
| 🟠 | [#27 – Oprettelse af KSP/CICS konti på baggrund af rolletildelinger](https://github.com/OS2sofd/issues/issues/27) | 178 dage / 5.8 mdr. | Klar til prioritering | Mellem | 0 dage siden |
...
> ⚠️ **Aktuel største kø / potentiel flaskehals:** 68 af 89 aktive ændringsønsker (76.4 %) står i **Afventer løsningsbeskrivelse**. Rapporten kan endnu ikke måle tid i status historisk, så den kan ikke alene afgøre, om dette er en vedvarende flaskehals.
...
| Afventer løsningsbeskrivelse | 68 | 76.4 % | 97 dage / 3.2 mdr. | 10 dage / 0.3 mdr. | 10 dage / 0.3 mdr. | 22 | 0 |
| Klar til prioritering | 10 | 11.2 % | 116 dage / 3.8 mdr. | 0 dage / 0 mdr. | 10 dage / 0.3 mdr. | 4 | 0 |
...
| Løsninger i test | 1 | 1.1 % | 70 dage / 2.3 mdr. | 10 dage / 0.3 mdr. | 10 dage / 0.3 mdr. | 0 | 0 |
...
| – | [#58 – OS2sofd - ilm - udfyld UPN ved oprettelse af konsulentkonto](https://github.com/OS2sofd/issues/issues/58) | 116 dage / 3.8 mdr. | ≥ 10 dage / 0.3 mdr. | ilm | Norddjurs | 3.250kr | – | – |
| – | [#59 – OS2sofd - ilm: udfyld displayName ved oprettelse af konsulent](https://github.com/OS2sofd/issues/issues/59) | 116 dage / 3.8 mdr. | ≥ 10 dage / 0.3 mdr. | ilm | Norddjurs | 1.000kr | – | – |
| – | [#105 – OS2ILM: Flytning af ILM-oprettede konsulenter](https://github.com/OS2sofd/issues/issues/105) | 34 dage / 1.1 mdr. | ≥ 10 dage / 0.3 mdr. | ilm | Norddjurs | 2.250kr | – | – |
...
| Screening | 3 |
| Afventer løsningsbeskrivelse | 68 |
| Klar til prioritering | 10 |
| Bestilt hos leverandør | 4 |
...
| --- | --- | ---: | --- | --- | ---: |
| – | [#16 – Navne- og adressebeskyttelse:](https://github.com/OS2sofd/issues/issues/16) | 179 dage / 5.9 mdr. | Odsherred | stamdata, ui | 11 dage siden |
...
| – | [#84 – At kunne skrive data attribut værdier fra OS2Vikar oprettelse til Data attribut i Active Directory](https://github.com/OS2sofd/issues/issues/84) | 75 dage / 2.5 mdr. | Lyngby-Taarbæk | vikar, middleware | 11 dage siden |
...
<details>
<summary>Vis 68 issue(s)</summary>
...
| Høj | [#109 – Dobbelt hierarki: Lønhierarki og den administrative organisation. Oprettelse af det administrative hierarki foretages pba. LOS-koblinger og strukturerede valideringer.Ændringsønske](https://github.com/OS2sofd/issues/issues/109) | 33 dage / 1.1 mdr. | stamdata, datamodel og tilhørsforhold | Horsens | – | 11 dage siden |
| Mellem | [#10 – Udvid SOFDCoreADWritebackAgent til at understøtte forsk. OU'er](https://github.com/OS2sofd/issues/issues/10) | 179 dage / 5.9 mdr. | middleware, brugere og konti | Favrskov | – | 11 dage siden |
| Mellem | [#11 – Tilføj information om en AD konto er i brug + understøtte LocalExtensions i Mail skabeloner](https://github.com/OS2sofd/issues/issues/11) | 179 dage / 5.9 mdr. | mailskabelon/advis, middleware, funktionelle forbedringer | Favrskov | – | 11 dage siden |
| Mellem | [#13 – SofdCoreADReplicator - Handlinger ved grupper](https://github.com/OS2sofd/issues/issues/13) | 179 dage / 5.9 mdr. | drift og vedligehold, middleware | Favrskov | – | 11 dage siden |
| Mellem | [#17 – SOFD GUI: Udvidet overblik over tilhørsforhold og typer](https://github.com/OS2sofd/issues/issues/17) | 179 dage / 5.9 mdr. | ui, brugere og konti | Favrskov | – | 11 dage siden |
...
| Mellem | [#49 – Ændring af synkronisering af data ind i Nexus](https://github.com/OS2sofd/issues/issues/49) | 151 dage / 5 mdr. | bug, middleware | Tønder | – | 0 dage siden |
| Mellem | [#54 – Udvidet stillingskatalog og kodebaseret regelgrundlag i SOFD (og OS2Rollekatalog)](https://github.com/OS2sofd/issues/issues/54) | 125 dage / 4.1 mdr. | idm, datamodel og tilhørsforhold | Hjørring | – | 0 dage siden |
| Mellem | [#55 – Lederside - Forbedring af GUI for Pausemarkering ift. endusers](https://github.com/OS2sofd/issues/issues/55) | 125 dage / 4.1 mdr. | ui, lederside | Favrskov | – | 11 dage siden |
| Mellem | [#73 – OS2sofd Kommunikationsmodul - Ønsker til forbedringer](https://github.com/OS2sofd/issues/issues/73) | 89 dage / 2.9 mdr. | middleware, funktionelle forbedringer | Favrskov | – | 11 dage siden |
| Mellem | [#76 – Ny pladsholder og pladsholder funktion til mailskabelonen ”Digital post til medarbejder ved oprettelse af AD konto”](https://github.com/OS2sofd/issues/issues/76) | 85 dage / 2.8 mdr. | mailskabelon/advis, funktionelle forbedringer | Vallensbæk | – | 11 dage siden |
...
| Mellem | [#85 – Brugernavn generator ved oprettelse af vikar (OS2Vikar)](https://github.com/OS2sofd/issues/issues/85) | 75 dage / 2.5 mdr. | vikar, brugere og konti | Lyngby-Taarbæk | – | 11 dage siden |
| Mellem | [#95 – Mulighed for at deaktivere en konto med udskudt dato](https://github.com/OS2sofd/issues/issues/95) | 68 dage / 2.2 mdr. | idm, brugere og konti | Tønder | – | 11 dage siden |
| Mellem | [#98 – OS2sofd Telefoni-modul - Ønsker til forbedringer](https://github.com/OS2sofd/issues/issues/98) | 56 dage / 1.8 mdr. | ui, funktionelle forbedringer | Favrskov | – | 11 dage siden |
| Mellem | [#104 – OS2ILM: Placering af medarbejdere i OU](https://github.com/OS2sofd/issues/issues/104) | 34 dage / 1.1 mdr. | idm, ilm | Norddjurs | – | 11 dage siden |
| Mellem | [#102 – OS2ILM: Mere specifik log](https://github.com/OS2sofd/issues/issues/102) | 34 dage / 1.1 mdr. | log-data, ilm | Norddjurs | – | 11 dage siden |
| Mellem | [#110 – Frigørelse af kobling mellem it-brugerkonto og tilhørsforhold fra løndata. Tilhørsforhold skal afspejle den administrative organisation i OS2sofd.Ændringsønske](https://github.com/OS2sofd/issues/issues/110) | 33 dage / 1.1 mdr. | brugere og konti, datamodel og tilhørsforhold | Horsens | – | 11 dage siden |
| Lav | [#15 – Behov for at kunne vise forskelligt displaynavn på ansatte med flere tilhørsforhold/AD-konti](https://github.com/OS2sofd/issues/issues/15) | 179 dage / 5.9 mdr. | brugere og konti, datamodel og tilhørsforhold | Sønderborg | – | 11 dage siden |
| Lav | [#29 – Brugertjek: Mulighed for genveje og dybe links](https://github.com/OS2sofd/issues/issues/29) | 178 dage / 5.8 mdr. | ui, brugertjek | Bornholm | – | 11 dage siden |
...
| Lav | [#26 – Brugertjek: Robot-flag for robotter](https://github.com/OS2sofd/issues/issues/26) | 178 dage / 5.8 mdr. | ui, brugertjek | Bornholm | – | 11 dage siden |
| Lav | [#28 – Brugertjek: Kontrol af lønsystem konto](https://github.com/OS2sofd/issues/issues/28) | 178 dage / 5.8 mdr. | idm, brugertjek | Bornholm | – | 11 dage siden |
| Lav | [#37 – Tilknytning af stillinger til enheder i Vikar modulet](https://github.com/OS2sofd/issues/issues/37) | 172 dage / 5.7 mdr. | vikar, ui | Tårnby | – | 11 dage siden |
...
| Lav | [#48 – Stoppet medarbejder slettes i Lederportalen/Tillidserhverv](https://github.com/OS2sofd/issues/issues/48) | 155 dage / 5.1 mdr. | lederside, brugere og konti | Odsherred | – | 11 dage siden |
| Lav | [#52 – Automatisk dannede flow-diagrammer til OS2sofd](https://github.com/OS2sofd/issues/issues/52) | 133 dage / 4.4 mdr. | dokumentation, log-data | Ikke kommune | – | 11 dage siden |
| Lav | [#60 – SMS/Kodeordspåmindelse: understøttelse af flere kodeordspolitikker](https://github.com/OS2sofd/issues/issues/60) | 112 dage / 3.7 mdr. | mailskabelon/advis, middleware | Bornholm | – | 11 dage siden |
| Lav | [#69 – Mulighed for at fravælge advis ved kontooprettelse](https://github.com/OS2sofd/issues/issues/69) | 97 dage / 3.2 mdr. | idm, mailskabelon/advis | Kalundborg | – | 11 dage siden |
| Lav | [#71 – Videreudvikling af SMS modul](https://github.com/OS2sofd/issues/issues/71) | 97 dage / 3.2 mdr. | mailskabelon/advis, middleware | Kalundborg | – | 11 dage siden |
| Lav | [#70 – Mulighed for at redigere og flytte kolonner i oversigtsbillederne](https://github.com/OS2sofd/issues/issues/70) | 97 dage / 3.2 mdr. | ui | Kalundborg | – | 11 dage siden |
| Lav | [#64 – Brugertjek : oplysninger om sidste kodeordsskifte og kodeordsløb i OS2faktor fanen](https://github.com/OS2sofd/issues/issues/64) | 97 dage / 3.2 mdr. | api, brugertjek | Kalundborg | – | 11 dage siden |
| Lav | [#66 – Mulighed for at redigere allerede oprettet arbejdssted](https://github.com/OS2sofd/issues/issues/66) | 97 dage / 3.2 mdr. | ui, funktionelle forbedringer | Kalundborg | – | 11 dage siden |
| Lav | [#67 – Kommunikationsmodul - Udviklingsønsker til email og log](https://github.com/OS2sofd/issues/issues/67) | 97 dage / 3.2 mdr. | log-data, mailskabelon/advis | Kalundborg | – | 11 dage siden |
| Lav | [#72 – Ekstra data på skoleelever](https://github.com/OS2sofd/issues/issues/72) | 97 dage / 3.2 mdr. | stamdata, middleware | Kalundborg | – | 11 dage siden |
...
| Lav | [#78 – Bjælke for oven og i venstre side, skal fryses fast](https://github.com/OS2sofd/issues/issues/78) | 81 dage / 2.7 mdr. | ui | Tønder | – | 11 dage siden |
...
| Lav | [#81 – At kunne ændre afsendernavn på mails fra Rollekatalog](https://github.com/OS2sofd/issues/issues/81) | 76 dage / 2.5 mdr. | ui, mailskabelon/advis | Lyngby-Taarbæk | – | 11 dage siden |
| Lav | [#88 – Ny kolonne i rapporten 'Historiske rolleanmodninger', så man kan se hvilket IT-System de forskellige roller er tilknyttet](https://github.com/OS2sofd/issues/issues/88) | 75 dage / 2.5 mdr. | rapporter, idm | Lyngby-Taarbæk | – | 11 dage siden |
...
| Lav | [#96 – Vis detaljer om hvem der har bestilt/oprettet en konto undrer ordre-detaljer](https://github.com/OS2sofd/issues/issues/96) | 61 dage / 2 mdr. | log-data, idm | Allerød | – | 11 dage siden |
| Lav | [#99 – Understøtte ny Skole/SFO opmærkning til KOMBIT](https://github.com/OS2sofd/issues/issues/99) | 48 dage / 1.6 mdr. | stamdata, middleware | Ikke kommune | – | 11 dage siden |
| Lav | [#103 – OS2ILM: Visning af firma og navn](https://github.com/OS2sofd/issues/issues/103) | 34 dage / 1.1 mdr. | ui, ilm | Norddjurs | – | 11 dage siden |
...
| – | [#12 – Forstå forskel på Ansatte, Eksterne, Byrøddet, Konsulenter, Vikarer, m.m. typer af AD konti](https://github.com/OS2sofd/issues/issues/12) | 179 dage / 5.9 mdr. | idm, brugere og konti | Sønderborg | – | 11 dage siden |
| – | [#30 – OS2sofd - ILM: Vedligeholdelse af Fortrolighedsaftale](https://github.com/OS2sofd/issues/issues/30) | 178 dage / 5.8 mdr. | idm, ilm | Bornholm | – | 11 dage siden |
| – | [#62 – Udvidelse af Opus-integrationen med mulighed for at overføre flere brugerkontotyper](https://github.com/OS2sofd/issues/issues/62) | 105 dage / 3.4 mdr. | middleware, brugere og konti | Egedal | – | 11 dage siden |
| – | [#68 – API-udvidelse til undtagelse/pausemarkering](https://github.com/OS2sofd/issues/issues/68) | 97 dage / 3.2 mdr. | idm, api | Kalundborg | – | 11 dage siden |
| – | [#86 – OS2Vikar mulighed for at angive tid ved oprettelse af vikar](https://github.com/OS2sofd/issues/issues/86) | 75 dage / 2.5 mdr. | vikar | Lyngby-Taarbæk | – | 11 dage siden |
| – | [#87 – Begrænse en systemansvarlig's view af it-systemer i OS2Rollekatalog](https://github.com/OS2sofd/issues/issues/87) | 75 dage / 2.5 mdr. | idm, ui | Lyngby-Taarbæk | – | 11 dage siden |
| – | [#101 – OS2ILM: Tildeling af leder via Virksomhed](https://github.com/OS2sofd/issues/issues/101) | 34 dage / 1.1 mdr. | ui, ilm | Norddjurs | – | 11 dage siden |
| – | [#112 – Migrering til Datafordeleren til CPR opslag](https://github.com/OS2sofd/issues/issues/112) | 26 dage / 0.9 mdr. | api, drift og vedligehold | Ikke kommune | – | 11 dage siden |
...
| --- | ---: | --- | --- | ---: |
| [#94 – Understøttelse af Pre-hire-brugere i snitfladen mellem SOFD og Rollekatalog](https://github.com/OS2sofd/issues/issues/94) | 70 dage / 2.3 mdr. | 3. kvartal 2026 | – | 10 dage siden |
...
| [#49 – Ændring af synkronisering af data ind i Nexus](https://github.com/OS2sofd/issues/issues/49) | Afventer løsningsbeskrivelse | 151 dage / 5 mdr. | Issue er lukket, men Project-status er aktiv |
